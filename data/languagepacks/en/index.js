...
export default {
  ...
  gameover: {
    ...
    summary:    'Reached: day {day}, mission {mission}.',
    backToMenu: 'Back to main menu.',
  },

  // Run-result report (runResult.js) — strings shared across end-of-run scenes.
  runResult: {
    metaPointsEarned: 'Meta-points earned: {points}.',
  },
